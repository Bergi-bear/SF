...
function InitSpellTrigger()
	...
	TriggerAddAction(SpellTrigger, function()
		...
		elseif spellId == FourCC('A095') then -- Призыв Случайного Демона
			...
			CreateUnitSimpleEffect(caster,FourCC('n011'),"Abilities/Spells/Undead/RaiseSkeletonWarrior/RaiseSkeleton.mdl")
			CreateUnitSimpleEffect(caster,FourCC('n013'),"Abilities/Spells/Undead/RaiseSkeletonWarrior/RaiseSkeleton.mdl")
